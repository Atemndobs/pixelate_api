...
class PostController extends Controller
{
    ...
    public function store()
    {
        ...
        if ($this->request->hasFile('image')) {
            $imageUrl = $this->request->image->store('/posts', 'public');
        ...
        $createdPost = $this->postRepository->find($post->id);

        broadcast(new PostCreatedEvent($createdPost, $user));

        return responder()->success($createdPost, PostTransformer::class);
    }
    ...
    public function toggleLike(ReactionService $reactionService)
    {
        ...
        $reaction->type = $type;
        $reactedPost = $this->postRepository->find($post->id);
        $reactedPost['position'] = $this->request->position;
