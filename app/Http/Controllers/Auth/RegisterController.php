...
class RegisterController extends Controller
{
    ...
    */
     ...
     *       @OA\Property(property="username", type="string", format="password", example="Fanny"),
     *       @OA\Property(property="name", type="string", format="password", example="Fanny Besoz"),
     ...
     *    description="Success",
     *    @OA\JsonContent(
     *       @OA\Property(property="name", type="string", example="Fanny Anna"),
     *       @OA\Property(property="username", type="string", example="Fanny"),
     *       @OA\Property(property="email", type="string", example="fanny256@email.com"),
